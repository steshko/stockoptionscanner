...
export default function BestSpreadsPutTable(props: any) {
    ...
    const columns: Column[] = useMemo(() =>  [
        ...
        {header: 'Earning', fieldName: '',  sorting: false, align: 'center', onDrawCell: DrawEarning},
        {header: 'Dividends', fieldName: '',  sorting: false, align: 'center', onDrawCell: DrawDividends},
        ...
        {header: 'Discount', fieldName: 'discount',  sorting: true, toFixed:0, align: 'center', disablePadding: true},
        {header: 'By min', fieldName: 'resP', toFixed:2, align: 'center'},
        {header: 'By mid', fieldName: 'res', toFixed:2, align: 'center', onDrawCell: DrawOptionMid},
